...
partial class DarkMode : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("DarkMode");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named DarkMode - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new DarkMode(visual);
            visual.Width = 0;
        ...
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(DarkMode)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("DarkMode", () => 
        {
    ...
    public DarkMode(InteractiveGue visual) : base(visual)
    {
        InitializeInstances();
        CustomInitialize();
    }
    public DarkMode() : base(new ContainerRuntime())
    {
