...
partial class V4 : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("V4");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named V4 - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new V4(visual);
            visual.Width = 0;
        ...
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(V4)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("V4", () => 
        {
    ...
    public V4(InteractiveGue visual) : base(visual)
    {
        InitializeInstances();
        CustomInitialize();
    }
    public V4() : base(new ContainerRuntime())
    {
