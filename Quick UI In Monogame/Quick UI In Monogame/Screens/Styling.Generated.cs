...
partial class Styling : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Styling");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Styling - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new Styling(visual);
            visual.Width = 0;
        ...
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(Styling)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Styling", () => 
        {
    ...
    public Styling(InteractiveGue visual) : base(visual)
    {
        InitializeInstances();
        CustomInitialize();
    }
    public Styling() : base(new ContainerRuntime())
    {
