...
partial class Hotbar : global::Gum.Forms.Controls.FrameworkElement
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Hytale/Hotbar");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Hytale/Hotbar - did you forget to load a Gum project?");
#endif
        ...
        ElementSaveExtensions.RegisterGueInstantiation("Hytale/Hotbar", () => 
        {
    ...
    public StackPanel InnerStackPanel { get; protected set; }
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        InnerStackPanel = global::Gum.Forms.GraphicalUiElementFormsExtensions.TryGetFrameworkElementByName<StackPanel>(this.Visual,"InnerStackPanel");
        CustomInitialize();
    }
